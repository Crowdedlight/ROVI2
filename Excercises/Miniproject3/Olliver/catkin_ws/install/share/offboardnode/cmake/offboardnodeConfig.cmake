...
if("FALSE" STREQUAL "TRUE")
  set(offboardnode_SOURCE_PREFIX /home/crow/Documents/ROVI2/Excercises/Miniproject3/Olliver/catkin_ws/src/offboardnode)
  set(offboardnode_DEVEL_PREFIX /home/crow/Documents/ROVI2/Excercises/Miniproject3/Olliver/catkin_ws/devel)
  ...
  set(offboardnode_INSTALL_PREFIX /home/crow/Documents/ROVI2/Excercises/Miniproject3/Olliver/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'olliver <olliver@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'offboardnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/crow/Documents/ROVI2/Excercises/Miniproject3/Olliver/catkin_ws/install/${idir}'.  ${_report}")
    endif()
    _list_append_unique(offboardnode_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "offboardnode")
...
set(depends "geometry_msgs;mavros_msgs;roscpp;rospy")
